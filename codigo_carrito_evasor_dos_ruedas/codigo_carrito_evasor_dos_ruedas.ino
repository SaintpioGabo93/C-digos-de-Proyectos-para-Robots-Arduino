...
AF_DCMotor Motor_izquierdo(1, MOTOR12_1KHZ); // Objeto Motor 1 usando salida M1 del Driver, establece una frecuencida de 1kHZ en PWM
AF_DCMotor Motor_derecho(4, MOTOR34_1KHZ); // Objeto Motor 4 usando salida M4 del Driver, establece una frecuencida de 1kHZ en PWM
...
void mover_adelante(){
  ...
  {
    Motor_izquierdo.setSpeed(establecer_velocidad);
    Motor_derecho.setSpeed(establecer_velocidad);
    delay(5); 
     }
...
void girar_derecha(){
  ...
  Motor_derecho.setSpeed(establecer_velocidad + velocidad_maxima_compensado);
  delay(1500);
...
void girar_izquierda(){
  ...
  Motor_izquierdo.setSpeed(establecer_velocidad + velocidad_maxima_compensado);
  delay(1500);
